...
def map_erpnext_item_to_shopify(shopify_product: Product, erpnext_item):
	...
	shopify_product.title = shopify_product.title if hasattr(shopify_product, "title") else erpnext_item.item_name
	shopify_product.body_html = shopify_product.body_html if hasattr(shopify_product, "body_html") else erpnext_item.description
